...
@include("inc/_header.php");
		...
		case "404": include("pages/_404.php"); break; // Страница ошибки		
				...
				case "calk": include("pages/_calk.php"); break; // калькулятор
				...
				case "ppaymeants": include("pages/ppaymeants.php"); break; // Выплаты
				                case "paybanner": include("pages/_paybanner.php"); break; // paybanner
case "invcompetition": include("pages/_invcompetition.php"); break; // Конкурсы
				case "stock": include("pages/_stock.php"); break; // Выплаты
				case "faq": include("pages/_faq.php"); break; // Выплаты
				case "top": include("pages/_top.php"); break; // Выплаты
